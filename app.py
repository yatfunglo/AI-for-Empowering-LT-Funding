...
st.markdown("---")
st.info("同工你好！關於 50 萬「智啟學教」撥款，無論係買機規格、KPI 定係教學應用，我都可以幫你一齊諗諗。")
...
if prompt := st.chat_input("老師，有咩可以幫到你？"):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            # 💡 核心穩定寫法：移除 tools 參數以避開 v1beta 404 Bug
            # 如果需要聯網，建議在未來 API 穩定後再加回
            ...
            if response.text:
                ...
                st.error("AI 暫時無法生成文字，請重新嘗試。")

        except Exception as e:
            # 錯誤處理
            st.error("抱歉同工，系統連線出現問題。")
            with st.expander("查看技術錯誤 (IT組)"):
                st.write(str(e))
